<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-02-08 13:21:54
         compiled from "backend\design\html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8841034195c5aac7beeda16-72908660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8841034195c5aac7beeda16-72908660',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_5c5aac7c198536_76765148',
  'variables' => 
  array (
    'product' => 0,
    'btr' => 0,
...
<?php if ($_valid && !is_callable('content_5c5aac7c198536_76765148')) {function content_5c5aac7c198536_76765148($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\OSPanel\\domains\\okay\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.truncate.php';
...
" />
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-12">
                        <div class="activity_of_switch">
                            ...
                            <!--Переключатель "как радиобаттон"-->
                            <div class="activity_of_switch_item"> 
                                <div class="okay_switch clearfix">
                                    <label class="switch_label"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_radiobutton, ENT_QUOTES, 'UTF-8', true);?>
</label>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="radio" value="1" type="checkbox" id="radio_checkbox" <?php if ($_smarty_tpl->tpl_vars['product']->value->radio) {?>checked=""<?php }?>/>
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                </div>
